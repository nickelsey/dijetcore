...
def main(args) :
  ...
  ## some paths
  execpath = os.getcwd()
  executable = './bin/dijet_imbalance/differential_aj_auau_y14'
  ## find the qwrap file
...
if __name__ == "__main__":
  ...
  parser.add_argument('--offAxisData', default='resources/data_lists/y14_mb_file_list.txt', help='data file/list for estimating the effect of background on the dijet imbalance')
