...
def updatestatus(jobstatus, outdir, name):
    ...
    for i in range(len(jobstatus)):
        ...
        jobinprocess = qstat_result.find(b(name + str(i)))
        if jobinprocess >= 0:
            jobstatus[i] = 1
            continue
...
if __name__ == "__main__":
    ...
    parser.add_argument('--triggers', default='y7ht',
    ...
    parser.add_argument('--offAxisData', default='resources/data_lists/y7_mb_file_list.txt',
