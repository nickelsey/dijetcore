...
if __name__ == "__main__":
    ...
    parser.add_argument('--embedFile', default='resources/data_lists/y14_mb_file_list.txt',
    ...
    parser.add_argument('--efficiencyFile', default='resources/efficiencies/y14_effic_dca1.root',
    ...
    parser.add_argument('--embedTriggers', default='y14vpdmb30',
