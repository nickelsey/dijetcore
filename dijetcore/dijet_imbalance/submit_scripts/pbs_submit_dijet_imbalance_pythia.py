...
def main(args):
    ...
    while checkstatus(jobstatus):
        ...
        if qsubfail > int(args.maxFailures):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--nJobs', type=int, default=100,
                        help=' number of pythia jobs to submit ')
    parser.add_argument('--nEvents', default='1e5',
                        help=' number of events per job')
    parser.add_argument('--maxFailures', default=200,
                        help=' number of job submissions that can fail before forcing an exit')
    parser.add_argument('--pTHatMin', default='10000',
                        help=' number of job submissions that can fail before forcing an exit')
    ...
    parser.add_argument('--maxRunningJobs', type=int, default=100,
