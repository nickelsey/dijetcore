...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("trees/y7/y7_grid_20_10.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("trees/y7/y7_grid_20_10.root");
      }
      f->GetObject("LEAD_INIT_R_0.4_alg_2_pt_20_const_eta_1_const_pt_1.5_MATCH_R_0.4_alg_2_pt_0_const_eta_1_const_pt_0.2_SUB_INIT_R_0.4_alg_2_pt_10_const_eta_1_const_pt_1.5_MATCH_R_0.4_alg_2_pt_0_const_eta_1_const_pt_0.2",tree);
