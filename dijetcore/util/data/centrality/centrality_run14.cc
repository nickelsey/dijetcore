...
namespace dijetcore {
  ...
  void CentralityRun14::setVzParameters(double par0, double par1, double par2, double par3,
  ...
  void CentralityRun14::setWeightParameters(const std::vector<double>& pars, double bound) {
    weight_par_.clear();
    weight_bound_ = 0;
    if (pars.size() != 7) {
