...
def generate_submission(executable, config, qwrap, execpath, outstream, errstream,
    ...
    submit = 'qsub -V -p {} -lmem={}G -lnodes={}:ppn={} -q {} -o {} -e {} -N {}_{} -- {} {} {} --logtostderr --name={} --id={} --config={}'.format(
...
def main(args):
    ...
    jobstatus = [0 for i in range(numjobs)]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--numjobs', type=int, default=24,
                        help=' total number of jobs to submit')
