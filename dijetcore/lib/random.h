#ifndef DIJETCORE_LIB_RANDOM_H
#define DIJETCORE_LIB_RANDOM_H

// implements commonly used random number distributions

// to use the counter inside the dijetcore library, call the singleton
// Counter::instance().
